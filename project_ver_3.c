...
GLfloat object_x_max, object_x_min, object_y_max, object_y_min, object_z_min = -1.0, object_z_max = 1.0; //these will serve as the edges
...
int main(int argc, char **argv){
    ...
    printf("Press 's' to decrease the object radius and 'S' to increase the object radius");
